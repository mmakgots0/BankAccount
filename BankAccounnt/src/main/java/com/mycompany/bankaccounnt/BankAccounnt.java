...
public class BankAccounnt {
     static float AccountBal,AccountBal2;
     static int PIN,phoneNum,DOB,choice,AccountNum=  225556644;
     static String name,surname,title,choices,Option,AccountHol= "Ms. M.Thejane";
    ...
    public static void Details(){
        ...
        System.out.println("Acount Holder: "+ title+" "+name+" "+ surname);
        System.out.println("Account Number: "+ AccountNum);
    ...
    public static void setDeposit(){
         ...
         amount=t.nextFloat();
         AccountBal = InitialBal + amount;
         System.out.println("Account Balance: R "+ AccountBal);
         InitialBal=AccountBal;     
    }
    ...
    public static void Transfers(){
       ...
       amount= v.nextFloat();
       AccountBal2= InitialBal2 + amount;        
       System.out.println("Account2 Balance : R" + AccountBal2);
    }
              ...
              choice=s.nextInt();
                 switch(choice){
                    ...
                    case 5 -> {
                        ...
                        System.out.println("****************************************");
                        AccountBal=InitialBal-amount;
                        System.out.println("Main account Balance : R"+ AccountBal);
                    }
